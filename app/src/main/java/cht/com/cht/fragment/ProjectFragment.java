 ...
 */
public class ProjectFragment extends Fragment implements View.OnClickListener, SwipeRefreshLayout.OnRefreshListener, FragmentActivityTitleAdapter.LoadMore {
    ...
    public void onActivityCreated(@Nullable Bundle savedInstanceState) {
        ...
        mAdapter.setCallbackLoad(ProjectFragment.this);
        initData();
