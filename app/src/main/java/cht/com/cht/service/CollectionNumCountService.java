 ...
 */
public interface CollectionNumCountService {
    @Headers(RetrofitManager.CACHE_CONTROL_AGE + RetrofitManager.CACHE_STALE_LONG)
    @FormUrlEncoded
    @POST("/cht/servlet/CollectionNumServlet")
    Observable<BaseModel<Message>> getCollectionNum(@Field("user_id") int user_id);
}
